      ...
      <section>
        ...
        >
          <div className='bg-slate-950/60 h-full w-full'>
            <div className='container flex items-center justify-center h-full flex-col text-[--sub3-text-color]'>
              <h1 className='text-3xl font-bold text-[--sub3-text-color]'>
              ...
              <p className='text-lg my-4'>
                ...
                <b className='text-[--sub1-color]'>#1</b> Việt Nam được đầu tư
